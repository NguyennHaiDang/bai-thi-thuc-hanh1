...
(   2,    -- CustomerID - int
    ...
    N'VIỆT NAM', -- Country - nvarchar(50)
    '0929650564', -- Phone - nvarchar(15)
    N'danghaidang941@fpt.edu.vn'  -- Email - nvarchar(50)
    ),
(   3,    -- CustomerID - int
...
VALUES
(   '999966666',   -- AccountNumber - char(9)
    1,    -- CustomerID - int
    60000, -- Balance - money
    500000  -- MinAccount - money
    ),
(   '777766666',   -- AccountNumber - char(9)
    2,    -- CustomerID - int
    80000000, -- Balance - money
    7000000000  -- MinAccount - money
    ),
(   '567899999',   -- AccountNumber - char(9)
    3,    -- CustomerID - int
    7000000, -- Balance - money
    400000000 -- MinAccount - money
    )
...
(   3,    -- TransactionID - int
    '567899999', -- AccountNumber - char(9)
    '20220122', -- TransactionDate - smalldatetime
    400000, -- Amount - money
